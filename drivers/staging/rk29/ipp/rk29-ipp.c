...
int ipp_do_blit(const struct rk29_ipp_req *req)
{
	...
	if(pre_scale)
	{
		if(((IPP_ROT_90 == rotate) || (IPP_ROT_270 == rotate)))
		{
			...
			if((req->src0.w%pre_scale_w)!=0) //����ȡ�� ceil
			{
			...
			if((req->src0.h%pre_scale_h)!=0)//����ȡ�� ceil
			{
	...
	if((IPP_ROT_90 == rotate) || (IPP_ROT_270 == rotate))
	{
		if (( (req->src0.h%req->dst0.w)!=0)||( (req->src0.w%req->dst0.h)!= 0)//С����С
	...
	{
		if (( (req->src0.w%req->dst0.w)!=0)||( (req->src0.h%req->dst0.h)!= 0)//С����С
